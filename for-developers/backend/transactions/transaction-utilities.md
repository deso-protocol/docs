...
| PostEntryResponse | ``[`PostEntryResponse`](../blockchain-data/basics/data-types.md#postentryresponse)             | If a transaction is a submit post transaction, the `PostEntryResponse` that was created by the transaction is included                                               |
{% endtab %}
{% endtabs %}
{% endswagger-response %}
...
{% swagger method="post" path="" baseUrl="/api/v0/get-txn" summary="Get Transaction" %}
{% swagger-description %}
...
| Name     | Type    | Description                                          |   |
| -------- | ------- | ---------------------------------------------------- | - |
| TxnFound | boolean | If true, the transaction is currently in the mempool |   |
{% endtab %}
{% endtabs %}
{% endswagger-response %}
