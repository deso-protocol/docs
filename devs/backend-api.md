...
Get state of DeSo App, such as cost of profile creation and diamond level map. Example use in the [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L1106) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/base.go#L86).

**Parameters**

None; however, you need to send an empty JSON `{ }`. Otherwise, you will get 400 - Bad Request. More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/base.go#L63).
...
Check if Txn is currently in mempool. Example use in the [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/app.component.ts#L291) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L34).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L25).
...
Submit transaction to DeSo blockchain. Example use in [frontend](https://github.com/deso-project/docs/tree/48edcd8f15f30a527a2d6d927e87c83bf10becdb/devs/%60https:/github.com/deso-project/frontend/blob/96bdf0c40e05010ec62a1b1cdc78bf0d0fb2ef44/src/app/backend-api.service.ts#L496%60) and endpoint implementation in [backend](https://github.com/deso-project/docs/tree/48edcd8f15f30a527a2d6d927e87c83bf10becdb/devs/%60https:/github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L81%60).

**Parameters**

Read more on transaction format [here](https://github.com/deso-project/docs/blob/main/code/walkthrough.md#transaction-format). More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L69).
...
Update profile fields and receive corresponding Txn. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L816) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L247).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L214).
...
Prepare transaction for sending DeSo. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L470) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L837).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L817).
...
Prepare transaction for submiting a post. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L644) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1100).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1061).
...
Prepare a follow/unfollow transaction. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L855) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1331).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1314).
...
Prepare a like/unlike transaction. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L936) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1002).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L985).
...
Prepare transaction for buying/selling creator coin. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L1012) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1454).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1401).
...
Prepare transaction for transfering creator coin. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L1042) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1615).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1587).
...
Prepare transaction for sending diamonds 💎. Transaction needs to be signed and submitted through `api/v0/submit-transaction` before changes come into effect. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L954) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1750).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/transaction.go#L1739).
...
Get information about users. Request contains a list of public keys of users to fetch. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L520) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L34).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L21).
...
Temporary route to wipe [seedinfo cookies](https://github.com/deso-project/docs/blob/main/code/walkthrough.md#seed-creation-and-transaction-construction). This endpoint relies on [identity api](https://github.com/deso-project/docs/blob/main/devs/identity-api.md). Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L408) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L424).
...
Get user profile information. Default number of returned profiles is 20. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L723) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L513).

**Parameters**

OrderBy possible values: `{"influencer_stake", "influencer_post_stake", "newest_last_post", "newest_last_comment", "influencer_coin_price"}`. More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L455).
...
Get information about single profile. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L736) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L935).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L923).
...
Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L736) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1030).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L996).
...
Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L970) and implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1171).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1158).
...
Get followers. Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L839) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1440).

**Parameters**

Either publickey or username can be set. More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1288).
...
Get user metadata such as email and phone. This endpoint relies on [identity api](https://github.com/deso-project/docs/blob/main/devs/identity-api.md). Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L1131) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1523).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1507).
...
Get user notifications. This endpoint relies on [identity api](https://github.com/deso-project/docs/blob/main/devs/identity-api.md). Example use in [frontend](https://github.com/deso-project/frontend/blob/96bdf0c/src/app/backend-api.service.ts#L1099) and endpoint implementation in [backend](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1670).

**Parameters**

More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L1655).
...
More info on the request [here](https://github.com/deso-project/backend/blob/47bcc8a/routes/user.go#L2153).
